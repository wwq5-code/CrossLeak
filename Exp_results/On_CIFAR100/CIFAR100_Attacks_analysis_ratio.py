...
OUTPUT_PREFIX = "CIFAR100_Attacks_unl_ratio"
TABLE_NAME = "parsed_cifar100_attack_ratio_results.csv"
...
def print_summary(rows):
    print(f"{DATASET_LABEL} unlearning-ratio attack analysis parsed from results_unl_ratio.txt")
    for method in methods_in_rows(rows):
        method_rows = rows_for_method(rows, method)
