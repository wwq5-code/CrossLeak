...
if args.dataset == 'MNIST':
    ...
    test_set = MNIST('../data/mnist', train=False, transform=trans_mnist, download=False)
    ...
    train_set = CIFAR10('/home/weiqiwan/Data/data/cifar', train=True, transform=train_transform, download=True)
    test_set = CIFAR10('/home/weiqiwan/Data/data/cifar', train=False, transform=test_transform, download=True)
    ...
    test_set  = CIFAR100('/home/wwq/Data/data/data/cifar', train=False, transform=test_transform, download=True)
    train_set_no_aug = CIFAR100('/home/wwq/Data/data/data/cifar', train=True, transform=test_transform, download=True)
...
save_path = "global_vib_cifar100_fedavg.pt"
torch.save({
...
ckpt_path = "global_vib_cifar100_fedavg.pt"
