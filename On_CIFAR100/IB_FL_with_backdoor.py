...
if args.dataset == 'MNIST':
    ...
    backdoor_output_dir = os.path.join(os.path.dirname(__file__), "backdoored_cifar100")
    save_backdoored_samples(backdoored_train_set_for_save, backdoor_output_dir, dataset_name="CIFAR100")
...
save_path = "global_vib_cifar100_fedavg_backdoored.pt"
torch.save({
...
ckpt_path = "global_vib_cifar100_fedavg_backdoored.pt"
